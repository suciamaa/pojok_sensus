...
CREATE TABLE IF NOT EXISTS respondent_profiles (
    ...
    UNIQUE KEY uq_profile_id_key (id_key),
    UNIQUE KEY uq_profile_nim (nim),
...
CREATE TABLE IF NOT EXISTS questionnaire_responses (
    ...
    updated_at DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    UNIQUE KEY uq_questionnaire_id_key (id_key),
    ...
    CONSTRAINT fk_questionnaire_id_key FOREIGN KEY (id_key) REFERENCES respondent_profiles(id_key) ON UPDATE CASCADE ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
