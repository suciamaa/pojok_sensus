...
try {
    $stmt = $pdo->prepare("SELECT id_key, nim, nama, hp, angkatan, fakultas, program_studi, tempat_tinggal, nama_tempat, alamat, rt, rw, desa, kecamatan, kabupaten, kode_pos, latitude, longitude, full_address, status FROM respondent_profiles WHERE id_key=:id_key LIMIT 1");
